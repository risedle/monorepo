...
abstract contract BaseInitializeTest is BaseTest {
    ...
    function testInitializeRevertIfExecutedTwice() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IFLT.Uninitialized.selector));
        flt.initialize(data.totalCollateral, da, shares);
    }
    ...
    function testInitializeRevertIfNoTransfer() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IFLT.AmountInTooLow.selector));
        flt.initialize(data.totalCollateral, da, shares);
    }
    ...
    function testPancakeCallRevertIfCallerIsNotPair() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IFLT.Unauthorized.selector));
    ...
    function testInitializeWithLeverageRatio2x() public {
        ...
        // Check total debt
        assertEq(flt.totalDebt(), da, "invalid total debt");
        ...
        assertGt(price, data.initialPriceInETH - tolerance, "price too low");
        assertLt(price, data.initialPriceInETH + tolerance, "price too high");
        ...
        assertEq(flt.debt().balanceOf(address(flt)), 0, "invalid balance");
    }
