...
import { IFLTRouter } from "src/IFLTRouter.sol";
...
abstract contract BaseRouterTest is BaseTest {
    ...
    function testRouterGetAmountInRevertIfFLTIsInvalid() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IFLTRouter.InvalidFLT.selector)
        );
    ...
    function testRouterGetAmountInRevertIfTokenInIsInvalid() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IFLTRouter.InvalidTokenIn.selector)
        );
    ...
    function testRouterGetAmountIn() public {
        ...
        tokenIn = address(flt.collateral());
        amountIn = router.getAmountIn(address(flt), tokenIn, amountOut);
        // Get the value
    ...
    function testRouterSwapTokensForExactFLTRevertIfFLTIsInvalid() public {
        ...
        router.swapTokensForExactFLT(tokenIn, 2 ether, flt, 1 ether);
    }
    ...
    function testRouterSwapTokensForExactFLTRevertIfTokenInIsInvalid() public {
        ...
        router.swapTokensForExactFLT(tokenIn, 2 ether, address(flt), 1 ether);
    }
    ...
    function testRouterGetAmountOutRevertIfTokenOutIsInvalid() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IFLTRouter.InvalidTokenOut.selector)
        );
    ...
    function testRouterGetAmountOut() public {
        ...
        // Get collateral token amount
        tokenOut = address(flt.collateral());
        amountOut = router.getAmountOut(address(flt), tokenOut, amountIn);
        // Get the value
    ...
    function testRouterSwapExactFLTForTokensRevertIfFLTIsInvalid() public {
        ...
        router.swapExactFLTForTokens(flt, 1 ether, tokenOut, 2 ether);
    }

    /// @notice Make sure it revert if tokenOut is invalid
    function testRouterSwapExactFLTForTokensRevertIfTokenOutIsInvalid()
        public
    {
        // Setup contracts
        Data memory data = getData();
        ...
        router.swapExactFLTForTokens(address(flt), 1 ether, tokenOut, 2 ether);
    }
