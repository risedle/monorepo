...
abstract contract BaseTest is Test {
    ...
    function getAmountIn(
        ...
        uint256 _shares,
        address _tokenIn
    ) internal view virtual returns (uint256 _amountIn);
    ...
    function setBalance(
        ...
        vm.store(_token, keccak256(abi.encode(_to, _slot)), bytes32(_amount));
    }
    ...
    function deployAndInitialize(Data memory _data, uint256 _lr)
        internal
        returns (IFLT _flt)
    {
        // Deploy FLT
        ...
        _flt.debt().approve(address(_flt.fDebt()), _data.debtSupplyAmount);
        ...
        setBalance(address(_flt.debt()), _data.debtSlot, address(this), send);
