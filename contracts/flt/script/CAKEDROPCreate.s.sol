...
contract CreateCAKEDROP is Script {
    function run() public {
        ...
        string memory name = "2X Short CAKE Risedle";
        string memory symbol = "CAKEDROP";
        bytes memory data = abi.encode(fBUSD, fCAKE, oracle, pair, router);
