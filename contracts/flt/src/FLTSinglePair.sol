...
import { IFuseComptroller } from "src/interfaces/IFuseComptroller.sol";
...
contract FLTSinglePair is IFLT, ERC20, Owned {
    ...
    function deploy(
        ...
        // Parse data
        (address fc, address fd, address o, address p, address r) = abi.decode(
            _data,
        ...
        returns (uint256 _value)
    {
        ...
        uint256 dv = oracleAdapter.totalValue(address(debt), address(0), da);
