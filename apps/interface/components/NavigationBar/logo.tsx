...
export const NavigationBarLogo = () => {
    ...
    const styles = {
        container: ["flex-none"].join(" "),
        logo: ["flex", "flex-row", "gap-2", "items-center"].join(" "),
        logoText: [
            "font-bold",
            "font-inter",
            "text-base",
    ...
    return (
        <div data-testid="NavigationBarLogo" className={styles.container}>
            <a href="https://risedle.com" className={styles.logo}>
